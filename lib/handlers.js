...
handlers.sample = (data, callback) => {
    callback(406,{'sample message' : 'And this, is the sample Deixe Leve handler'});
    console.info('data: ', data);
};

// Hello handler
handlers.hello = (data, callback) => {
    callback(406,{'message' : 'Hello! This is a warm welcome from this Deixe Leve application.  =)'});
    console.info('data: ', data);
};
