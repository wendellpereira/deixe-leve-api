...
handlers.main = (data, callback) => {
    callback(200, {'message' : 'This is the Deixe Leve main handler.'});
    console.info('data: ', data);
};

// Sample handler
handlers.sample = (data, callback) => {
    callback(200,{'sample message' : 'And this, is the sample Deixe Leve handler'});
    console.info('data: ', data);
};

// Hello handler
handlers.hello = (data, callback) => {
    callback(200,{'message' : 'Hello! This is a warm welcome from this Deixe Leve application.  =)'});
    console.info('data: ', data);
};
...
// @TODO Only let an authenticated user update their object. Dont let them access update anyone else's.
